...
public class TR extends AbstractFragment {
...
//    public AdView adView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View contentView = inflater.inflate(R.layout.fragment_tr, container, false);
...
//        FGTSCorrigido.getInstance().showInterstitialControl = 0;
    ...
    public void mountGridScreen480(ArrayList<Indice> _indices) {
        ...
        while(it.hasNext()) {
            ...
            if (currentIndice.type.equals("tr")) {
                if (j == 4) {
                    j = 0;
                    i++;
                }
